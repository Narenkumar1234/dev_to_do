  ...
  if (user) {
    return (
      <div className="flex items-center gap-3 px-4 py-2 rounded-xl backdrop-blur-sm" style={{ backgroundColor: `${currentTheme.colors.status.success}20` }}>
        ...
        <span className="text-sm font-medium text-green-700">Synced to cloud</span>
      </div>
    );
  }
    ...
    <>
      <div className="relative group">
        ...
        <button
          ...
          className="relative flex items-center gap-3 px-4 py-2 rounded-xl transition-all duration-300 transform hover:scale-105 active:scale-95 backdrop-blur-sm border"
          style={{ 
        ...
        >
          ...
          <span className="text-sm font-medium">Sign in to sync</span>
        </button>
      </div>
